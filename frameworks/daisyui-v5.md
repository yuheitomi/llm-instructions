...
6. Do not invent new class names. Only allowed class names are existing daisyUI class names or Tailwind CSS utility classes.
...
daisyUI without config looks like this:
...
daisyUI with all the default configs looks like this:
...
```css
@plugin "daisyui" {
  themes: light, dark, cupcake, bumblebee --default, emerald, corporate, synthwave --prefersdark,
